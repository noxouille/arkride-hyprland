...
function M.setup(c)
    ...
    -- NeoTree
    hi("NeoTreeNormal", { fg = c.fg1, bg = c.bg1 })
    ...
    hi("NeoTreeHiddenByName", { fg = c.bergard })
    hi("NeoTreeDotfile", { fg = c.bergard })
    ...
    hi("NeoTreeGitIgnored", { fg = c.bergard })
    ...
    -- Snacks
    hi("SnacksPickerDir", { fg = c.van_bright })
    hi("SnacksPickerFile", { fg = c.fg0 })
    hi("SnacksPickerListCursorLine", { bg = c.bg3 })
    hi("SnacksPickerMatch", { fg = c.feri, bold = true })
    hi("SnacksPickerTree", { fg = c.fg5 })
    hi("SnacksExplorerTree", { fg = c.fg5 })
    hi("SnacksExplorerDir", { fg = c.van_bright })
    ...
    hi("SnacksPickerGitStatusIgnored", { fg = c.bergard })
    hi("SnacksPickerHidden", { fg = c.bergard })
    hi("SnacksExplorerHidden", { fg = c.bergard })
    hi("SnacksPickerPathHidden", { fg = c.bergard })
    hi("SnacksPickerGitStatusModified", { fg = c.van })
    hi("SnacksPickerGitStatusAdded", { fg = c.elaine })
    hi("SnacksPickerGitStatusDeleted", { fg = c.aaron })
    hi("SnacksPickerGitStatusRenamed", { fg = c.risette })
    hi("SnacksPickerGitStatusStaged", { fg = c.elaine })
    ...
    hi("lualine_a_insert", { fg = c.bg0, bg = c.elaine, bold = true })
    ...
    hi("lualine_a_command", { fg = c.bg0, bg = c.feri, bold = true })
    hi("lualine_b_command", { fg = c.fg0, bg = c.bg5 })
    hi("lualine_c_command", { fg = c.fg0, bg = c.bg4 })
    hi("lualine_a_inactive", { fg = c.fg3, bg = c.bg2 })
    hi("lualine_b_inactive", { fg = c.fg3, bg = c.bg2 })
    hi("lualine_c_inactive", { fg = c.fg3, bg = c.bg2 })
end
