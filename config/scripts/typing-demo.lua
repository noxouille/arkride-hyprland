...
local code_samples = {
  lua = {
    filetype = "lua",
    code = [[
-- Arkride Color Palette
local M = {}

M.colors = {
  bg0 = "#13171d",
  fg0 = "#c5cdd9",
  van = "#5080C0",      -- Main blue
  agnes = "#EA7475",    -- Soft red
  feri = "#F8BA65",     -- Warm yellow
  aaron = "#D94848",    -- Bold red
...
pub static ARKRIDE_COLORS: &[Color] = &[
    Color::new("van", "#5080C0", (80, 128, 192)),
    Color::new("agnes", "#EA7475", (234, 116, 117)),
    Color::new("feri", "#F8BA65", (248, 186, 101)),
    Color::new("aaron", "#D94848", (217, 72, 72)),
];

fn main() {
    for color in ARKRIDE_COLORS {
        println!("{}{}:{} {}\x1b[0m",
